...
$serverDir = $dirs[0].FullName
$proc = New-Object -TypeName System.Diagnostics.Process
$proc.StartInfo.FileName = "D:\ServerBox\Java\JDK\jdk.1.8.0_151\bin\java.exe"
$proc.StartInfo.Arguments = "-jar D:\ServerBox\Servers\ColdFusion\cfusion\hf-updates\hotfix-006-308055.jar -i silent -f D:\ServerBox\Servers\ColdFusion\cfusion\hf-updates\hf-2016-0006-308055.properties"
