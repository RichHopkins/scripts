...
$proc.StartInfo.Arguments = "-jar D:\ServerBox\Servers\ColdFusion\cfusion\hf-updates\hotfix-015-318650.jar -i silent -f D:\ServerBox\Servers\ColdFusion\cfusion\hf-updates\hotfix-015-318650.properties"
