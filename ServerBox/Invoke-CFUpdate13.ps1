...
foreach ($dir in $dirs) {
	...
	Robocopy "\\isilon-hq-dfw\DevArchive\CF_Updates2" "$serverDir\hf-updates" /mir
}
#run the update and wait for it to end
$proc = New-Object -TypeName System.Diagnostics.Process
$proc.StartInfo.FileName = "D:\ServerBox\Java\JDK\jdk.1.8.0_151\bin\java.exe"
$proc.StartInfo.Arguments = "-jar D:\ServerBox\Servers\ColdFusion\cfusion\hf-updates\hotfix-013-316217.jar -i silent -f D:\ServerBox\Servers\ColdFusion\cfusion\hf-updates\hotfix-013-316217.properties"
