...
$url = "http://devops/Chocolatey/chocolatey.0.9.9.11.nupkg"
...
if ($unzipMethod -eq '7zip') {
  ...
  Download-File 'http://devops/Chocolatey/7za.exe' "$7zaExe"
...
choco source add -n=devops -s"http://devops/Chocolatey/nuget/" --priority=1
